...
// Minimal mock to use while developing (can expand or swap to API later)
const mockSources: Source[] = [
  ...
  },
  {
    ...
    name: 'BBC News',
    description:
      'Up-to-the-minute news, breaking news, video, audio and feature stories with trusted World and UK coverage.',
...
export const fetchSources = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('sources/fetchSources', async (_: void, { rejectWithValue }) => {
  try {
    return mockSources
  } catch {
...
//       "id": "bild",
//       "name": "Bild",
//       "description": "Die Seite 1 für aktuelle Nachrichten und Themen, Bilder und Videos aus den Bereichen News, Wirtschaft, Sport, und Promis.",
...
//     // Mock implementation - return the mock data instead of fetching from API
//     return mockSourcesResponse.sources
//   }
// )
